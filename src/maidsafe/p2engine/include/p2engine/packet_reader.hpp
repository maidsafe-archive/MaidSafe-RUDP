...
#ifndef P2ENGINE_PACKET_READER_HPP
#define P2ENGINE_PACKET_READER_HPP
...
namespace p2engine {
	...
	public:
		packet_reader(const safe_buffer& buf, size_t len = (std::numeric_limits<size_t>::max)()) 
			: base_type(buf, len, false) {};
		packet_reader(const basic_packet &init_packet) 
...
#endif // P2ENGINE_PACKET_READER_HPP
